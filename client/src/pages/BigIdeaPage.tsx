...
const PARAM_DESCRIPTIONS: Record<string, string> = {
  ...
  lookback: "Recent bars to check for signal. More bars = looser (wider detection window); fewer = tighter.",
  ...
  minBaseDays: "Min bars for base formation. Fewer = looser; more = tighter (needs longer base).",
